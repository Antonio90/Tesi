...
\\Infine, il terzo capitolo descrive come è stata fatta l'implementazione del sistema, mostrando porzioni di codice e screen dell'applicazione che ci aiutano nella comprensione di come il sistema funziona.
\\ Nell'ultimo capitolo sono trattate le ultime considerazioni finali del lavoro svolto ed i possibili sviluppi che potrebbero seguire. 
