...
Invece, nel listato \ref{lst:drawLine} sono riportate le righe di codice utili alla creazione dei collegamenti tra i vari nodi del grafo. In particolare, alla riga \ref{line:link} viene utilizzato il metodo \textit{link} di d3.js che prende in input i collegamenti che deve creare. A questi vengono aggiunte le coordinate di partenza e destinazione e l'icona a forma di freccia da utilizzare.
